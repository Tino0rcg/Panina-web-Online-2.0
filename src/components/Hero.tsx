...
const SLIDES = [
  {
    ...
    title: "Servicios TI para empresas <br /> que no pueden detenerse.",
    subtitle: "<strong>Aseguramos el 99.9% de disponibilidad de su infraestructura crítica en Chile.</strong>",
    description: "Soporte especializado y monitoreo proactivo 24/7 diseñado para eliminar riesgos y optimizar su rentabilidad.",
    features: [
      "Soporte TI Proactivo 24/7",
      "Continuidad de Negocio (BCP/DRP)",
      "Gestión de Infraestructura Crítica",
      "Outsourcing TI Profesional"
    ],
    statValue: "99.9%",
  ...
  },
  {
    ...
    title: "Diagnóstico <br /> TI 360° Valorado.",
    description: "<span class='font-medium text-primary'>Un análisis profesional de alto nivel cuya inversión es 100% abonable a su primer servicio. Reciba un reporte ejecutivo con roadmap estratégico y plan de mejora.</span>",
    features: [
      "Auditoría de Infraestructura",
      "Análisis de Vulnerabilidades",
      "Optimización de Procesos",
      "Evaluación de Arquitectura ERP",
      "Mapa de Riesgos TI",
      "Plan de Escalabilidad",
      "Cálculo de ROI",
      "Hoja de Ruta Tecnológica"
    ],
    statValue: "BONIFICADO",
    statLabel: "Inversión Recuperable",
    secondaryStatValue: "ROI",
    secondaryStatLabel: "Ahorro de Costos",
    secondaryStatHref: "/calculadora-roi",
    primaryButtonText: "Solicitar Mi Diagnóstico",
    primaryButtonHref: "#diagnostico",
    isBooking: false,
    secondaryButtonText: "Hablar con un Experto",
    secondaryButtonHref: "/?service=Diagnóstico TI#contact"
  },
  {
    id: 3,
    tag: "Ciberseguridad Corporativa",
    title: "Protección Total <br /> <span className='text-gradient'>Contra Ransomware.</span>",
    description: "Auditamos y blindamos sus activos digitales. Ciberseguridad proactiva para empresas que manejan información crítica bajo estándares internacionales.",
    statValue: "Zero",
    statLabel: "Brechas",
    secondaryStatValue: "24/7",
  ...
  },
  {
    ...
    title: "Integración de <br /> <span className='text-gradient'>Sistemas ERP y APIs.</span>",
    description: "Conecte Softland, SAP o Defontana con su ecosistema digital. Automatizamos la sincronización de datos para eliminar el error humano.",
    features: [
      "Integración certificada con Softland",
      "Reducción de errores operativos",
      "Sincronización E-commerce y ERP",
