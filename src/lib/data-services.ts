...
export const servicesData: ServiceData[] = [
  {
    ...
    description: "¿Su empresa necesita soporte informático en Santiago y no sabe a quién llamar cuando algo falla? Somos su equipo TI externo. Garantizamos la continuidad operativa con mantenimiento informático proactivo, asistencia técnica en terreno y outsourcing tecnológico que anticipa fallas antes de que ocurran. Protegemos su infraestructura y sus datos 24/7 para que usted solo se preocupe de hacer crecer su negocio.",
    cardDescription: "Técnico informático para empresas en Santiago: soporte TI proactivo, mantenimiento preventivo y outsourcing tecnológico que asegura su operación sin interrupciones.",
    icon: ShieldCheck,
    color: "text-accent",
  ...
  },
  {
    ...
    description: "¿Cansado de perder tiempo en tareas repetitivas que su equipo hace a mano? Automatizamos los procesos de su empresa en Chile para que trabaje más rápido, con menos errores y sin aumentar costos fijos. Desde la digitalización de flujos de trabajo hasta la integración de sistemas que 'no se hablaban', modernizamos su operación con ingeniería de software a medida para una verdadera transformación digital.",
    cardDescription: "Eliminamos el trabajo manual ineficiente: automatización de procesos, integración de sistemas y transformación digital para empresas que quieren operar más rápido y con menos costos.",
    icon: Rocket,
    color: "text-accent",
    glow: "shadow-[0_0_20px_-10px_rgba(45,183,193,0.5)]",
  ...
  },
  {
    ...
    description: "¿La red de su empresa es lenta, inestable o simplemente no aguanta la carga del día a día? Diseñamos y desplegamos infraestructura tecnológica robusta desde cero. Cableado estructurado certificado, firewalls, VoIP, control de acceso biométrico y redes LAN/WAN de alta velocidad. Conectividad empresarial que no falla cuando más la necesita, con seguridad perimetral de nivel corporativo.",
    cardDescription: "Red lenta o que se cae constantemente: diseñamos infraestructura de redes empresarial robusta, cableado certificado y seguridad perimetral para alta disponibilidad en Santiago y Chile.",
    icon: Settings2,
  ...
  },
  {
    ...
    description: "¿Le preocupa que su empresa sea víctima de un ataque de ransomware o que roben la información de sus clientes? No espere a que ocurra. Realizamos blindaje de red, auditorías de seguridad informática (ethical hacking), protección de endpoints y arquitecturas Zero Trust. Protegemos los datos sensibles de su empresa bajo estándares internacionales de ciberseguridad antes de que los atacantes encuentren la puerta abierta.",
    icon: ShieldCheck,
    color: "text-red-400",
